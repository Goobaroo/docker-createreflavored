# [Create Re-Flavored-6.43](https://www.curseforge.com/minecraft/modpacks/create-re-flavored) on Curseforge
...
The docker on first run will download the same version as tagged of Create Re-Flavored-6.43 and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "Create Re-Flavored-6.43 Server Powered by Docker"
* LEVEL world
